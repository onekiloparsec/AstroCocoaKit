...
- (void)testMakeWithEmptyDataInput
{
...
- (void)testMakeWithCorrectPositiveStringInput
{
...
- (void)testMakeWithCorrectNegativeZeroStringInput
{
	// 4 must produce KPCCoordinatesUnitsHours
...
- (void)testMakeSexagesimalComponentsWithPositiveInputSign
{
...
- (void)testMakeSexagesimalComponentsWithNegativeInputSign
{
...
- (void)testMakeSexagesimalComponentsWithZeroAndNegativeInputSign
{
...
- (void)testMakeSexagesimalComponentsWithMultipleZerosAndNegativeInputSign
{
...
- (void)testMakeSexagesimalComponentsWithAnotherZeroAndNegativeInputSign
{
...
- (void)testMakeSexagesimalComponentsWithAnotherAgainZeroAndNegativeInputSign
{
...
- (void)testMakeSexagesimalComponentsWitNegativeInputSignAndZeros
{
...
- (void)testMakeSexagesimalComponentsFromPositiveValue
{
...
- (void)testMakeSexagesimalComponentsFromNegativeValue
{
